...
const variants = cva('', {
	variants: {
		...
		gradient: {
			...
			royal:
				'from-blue-700/100 via-blue-700/50 to-blue-700/0 from-25%',
			...
			blue: 'from-blue-700/90 via-blue-700/50 to-blue-700/30',
			sky: 'from-blue-300/90 via-blue-300/80 to-blue-300/60',
			yellow: 'from-yellow-500/70 via-yellow-500/30 to-yellow-500/0',
